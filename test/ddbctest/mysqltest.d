...
version(USE_MYSQL) {
    ...
    class MySQLTest : DdbcTestFixture {
        ...
        this() {
            super(
                ...
                "CREATE TABLE IF NOT EXISTS `my_first_test` (`id` INTEGER AUTO_INCREMENT PRIMARY KEY, `name` VARCHAR(255) NOT NULL)",
    ...
    class MySQLTransactionTest : DdbcTestFixture {
        ...
        this() {
            super(
                    "ddbc:mysql://localhost:%s/testdb?user=testuser,password=passw0rd".format(environment.get("MYSQL_PORT", "3306")),
                    "CREATE TABLE IF NOT EXISTS `my_first_test` (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL);CREATE TABLE IF NOT EXISTS `records` (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL)",
